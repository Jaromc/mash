...
//-------------------------------------------------------------------------
#ifndef _C_MASH_GUI_LINE_BATCH_H_
#define _C_MASH_GUI_LINE_BATCH_H_
...
namespace mash
{
	...
	class CMashGUILineBatch : public MashReferenceCounter
	{
	private:
	...
	public:
		CMashGUILineBatch(MashGUIManager *pGUIManager,
			MashVideo *pRenderer, 
		...
		eMASH_STATUS Draw(const mash::MashVector2 &top, const mash::MashVector2 &bottom,
